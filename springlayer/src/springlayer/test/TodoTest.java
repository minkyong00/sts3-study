...
public class TodoTest {
	...
	public void a_insertTodo() {
		Todo todo1 = createTodo(1, "할일1", new Date(), false);
		Todo todo2 = createTodo(2, "할일2", new Date(), false);
		Todo todo3 = createTodo(3, "할일3", new Date(), false);
	...
	private Todo createTodo(int todoId, String todoContent, Date todoRegdate, boolean todoCompleted) {
