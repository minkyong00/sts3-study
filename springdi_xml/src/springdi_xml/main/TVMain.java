...
public class TVMain {
	...
	public static void main(String[] args) {
		...
		tv_setter.getParts().stream().forEach(System.out::println);
		tv_setter.getColors().stream().forEach(System.out::println);
		tv_setter.getYearPrice().entrySet().stream().forEach(System.out::println);
		tv_setter.getSpec().entrySet().stream().forEach(System.out::println);
